        ...
        public Samurai samurai
        {
            ...
            public class UpdateCommand1 : ICommand
            {
                ...
                public void Execute(object parameter)
                {
                    ...
                    ViewModel.Repository.UpdateSamurai(ViewModel.samurai.SamuraiId, ViewModel.samuraiName,
            ...
            public class UpdateCommand2 : ICommand
            {
                ...
                public void Execute(object parameter)
                {
                    ViewModel.Repository.UpdateBattle(ViewModel.contest.BattleId,ViewModel.battleName,
            ...
            public class AddCommand : ICommand
            {
                ...
                public void Execute(object parameter)
                {
                    ViewModel.Repository.AddSamuraiToBattle(ViewModel.samuraiId,
                                                      ViewModel.battleId);
